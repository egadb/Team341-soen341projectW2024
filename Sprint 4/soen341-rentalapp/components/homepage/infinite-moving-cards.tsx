      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--blue-200), var(--blue-100)",
            }}
            key={item.name}
          >
            <blockquote>
              ...
              <div className="flex justify-end mb-2">
                <GrStatusGood className=" text-green-600 text-3xl"/>
              </div>
              <span className=" relative z-20 text-sm leading-[1.6] text-slate-900">
                {item.quote}
              </span>
